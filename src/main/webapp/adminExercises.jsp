...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-2"></div>
        <div class="col-sm-8">
            <a href="/admin/addexercise">Add new</a><br/>
                ...
                <table class="table table-sm table-striped table-bordered">
                    ...
                    <c:forEach items="${exercises}" var="exercise">
                        <tr>
                            ...
                            <td><a href="/admin/editexercise?exerciseId=${exercise.id}">Edit</a>
                                <a href="/admin/delexercise?exerciseId=${exercise.id}">Delete</a>
                                <a href="/admin/solutions?exerciseId=${exercise.id}">Solutions</a>
                            </td>
                        </tr>
                    </c:forEach>
                </table>
