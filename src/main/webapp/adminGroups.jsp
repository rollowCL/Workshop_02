...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-2"></div>
        <div class="col-sm-8">
            <a href="/admin/addgroup">Add new</a><br/>
            <c:if test="${not empty groups}">
                <table class="table table-sm table-striped table-bordered">
                    ...
                    <tr>
                        <td>${group.name}</td>
                        <td><a href="/admin/editgroup?groupId=${group.id}">Edit</a>
                            <a href="/admin/delgroup?groupId=${group.id}">Delete</a>
                            <a href="/admin/users?groupId=${group.id}">Users</a>
                        </td>
                    </tr>
                    </c:forEach>
                </table>
