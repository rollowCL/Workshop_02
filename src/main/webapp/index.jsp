...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-8 shadow p-3 mb-5 bg-secondary rounded">
            <p class="text-center align-middle text-white font-weight-bolder ">
                Last submissions
            ...
            <c:if test="${not empty solutions}">
                <table class="table table-sm table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <th scope="col">Solution Author</th>
                    ...
                    <c:forEach items="${solutions}" var="solution">
                        <tr>
                            ...
                            <td><a href="/solutiondetails?solutionId=${solution.solution.id}">Details</a></td>
                        </tr>
                    </c:forEach>
                </table>
            </c:if>
